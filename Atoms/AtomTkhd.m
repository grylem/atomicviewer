...
- (NSString *)html
{
    ...
    NSString *html = [NSString stringWithFormat:@"<body><span style=\"font-size: 14px\"><font face=\"AvenirNext-Medium\"><p>Creation date: %@<br>Modification date: %@<br>Track ID: %u<br>Duration: %u (%02u:%02u:%09.6f)<br>Layer: %u<br>Alternate Group: %u<br>Volume: %u.%u<br>Transformation Matrix:<TABLE style=\"font-size:1.0em;\"><TR><TD>%u.%u</TD><TD>%u.%u</TD><TD>%u.%u</TD></TR><TR><TD>%u.%u</TD><TD>%u.%u</TD><TD>%u.%u</TD></TR><TR><TD>%u.%u</TD><TD>%u.%u</TD><TD>%u.%u</TD></TR></TABLE><br>Width: %u.%u<br>Height: %u.%u</p></span></body>", creationDate, modificationDate, track_ID, duration, hours, minutes, seconds, layer, alternate_group, volume_hi, volume_lo, matrixa_hi, matrixa_lo, matrixb_hi, matrixb_lo, matrixu_hi, matrixu_lo, matrixc_hi, matrixc_lo, matrixd_hi, matrixd_lo, matrixv_hi, matrixv_lo, matrixtx_hi, matrixtx_lo, matrixty_hi, matrixty_lo, matrixw_hi, matrixw_lo, width_hi, width_lo, height_hi, height_lo];
